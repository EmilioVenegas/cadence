...
plt.title('CADENCE Manifold Alignment: Latent Dimensions (Z) vs Clinical Features', fontsize=15)
...
plt.title('CADENCE Dynamics: Latent Velocity (V) vs Clinical Decline (Δ)', fontsize=15)
