...
def plot_all_tsne(df_merged, z_cols):
    ...
    plt.savefig('latent_velocity/plots/tsne_frailty_index.png', dpi=150)
    plt.close()
    ...
    plt.ylabel('t-SNE Dim 2')
    plt.grid(True, alpha=0.3)
    plt.savefig('latent_velocity/plots/tsne_age.png', dpi=150)
    plt.close()
    ...
    plt.ylabel('t-SNE Dim 2')
    plt.grid(True, alpha=0.3)
    plt.savefig('latent_velocity/plots/tsne_mortality.png', dpi=150)
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig('latent_velocity/plots/tsne_domains.png', dpi=150)
    plt.close()
