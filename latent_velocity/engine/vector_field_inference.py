...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', default=str(MODELS_DIR / 'beta_vae_model.pth'), help='Path to VAE model')
    parser.add_argument('--data', default=str(DATA_DIR / 'frailty_index_data.csv'), help='Path to raw dataset')
    parser.add_argument('--traj', default=str(MODELS_DIR / 'latent_velocity_trajectory.csv'), help='Path to continuous GP fields')
